...
export const config = {
  ...
  // Skip stale manual-input tweets older than this many days (0 disables age filter)
  MANUAL_INPUT_MAX_AGE_DAYS: Number(process.env.MANUAL_INPUT_MAX_AGE_DAYS || '14')
};
